 ...
 * @author HP
 */
public class AdminEditDelCountry extends javax.swing.JFrame {

    /**
     * Creates new form AdminEditDelCountry
     */
    public class Item {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modify/Delete Country");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        dispose();
        MainModule.AdminEditDelCountry aedc = new MainModule.AdminEditDelCountry();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        dispose();
        MainModule.AdminDispCountry adc = new MainModule.AdminDispCountry();
        adc.setVisible(true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (c_name.equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter new country name.");
            return;
        }
        try {
            MainModule.DB_Creds db = new MainModule.DB_Creds();
            ...
            Statement stmt;
            stmt = connection.createStatement();
            int f = stmt.executeUpdate("update country set country_name='" + c_name + "' where country_id=" + c_id);
            if (f > 0) {
                JOptionPane.showMessageDialog(null, "Country details updated.");
                jTextField3.setText("");
                jLabel1.setText("");
            } else {
                jTextField3.setText("");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(null,
                "Do you want to delete country?", "Confirmation Message", JOptionPane.YES_NO_OPTION);
        if (confirm == 0) {
            try {
                MainModule.DB_Creds db = new MainModule.DB_Creds();
                Connection connection = db.ConnectToDB();
                Statement stmt;
                stmt = connection.createStatement();
                int f = stmt.executeUpdate("delete from country where country_id=" + c_id);
                if (f > 0) {
                    JOptionPane.showMessageDialog(null, "Country details deleted.");
                    jTextField3.setText("");
                    jLabel1.setText("");
                } else {
                    jTextField3.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminEditDelCountry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminEditDelCountry().setVisible(true);
            }
        });
    }

 ...
 * @author HP
 */
public class AdminEditDelHospSpec extends javax.swing.JFrame {

    /**
     * Creates new form AdminEditDelHospSpec
     */
    public class Item {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modify/Delete Specialization");
        ...
        jLabel4.setText("New Hospital Speciality");
        ...
        jLabel6.setText("Selected Specialization");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        dispose();
        MainModule.AdminEditDelHospSpec aedc = new MainModule.AdminEditDelHospSpec();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        dispose();
        MainModule.AdminDispHospSpec adc = new MainModule.AdminDispHospSpec();
        adc.setVisible(true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (jLabel1.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Please select hospital speciality.");
            return;
        }
        int hs_id = jComboBox1.getItemAt(this.jComboBox1.getSelectedIndex()).getID();
        String hs_name = jTextField1.getText().toString();
        if (hs_name.equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter new name of specialization.");
            return;
        }
        try {
            MainModule.DB_Creds db = new MainModule.DB_Creds();
            ...
            Statement stmt;
            stmt = connection.createStatement();
            int f = stmt.executeUpdate("update hosp_spec set hosp_spec_name='" + hs_name + "' where hosp_spec_id=" + hs_id);
            if (f > 0) {
                JOptionPane.showMessageDialog(null, "Specialization details updated.");
                jTextField1.setText("");
                jLabel1.setText("");
            } else {
                jTextField1.setText("");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(null,
                "Do you want to delete specialization?", "Confirmation Message", JOptionPane.YES_NO_OPTION);
        if (confirm == 0) {
            try {
                MainModule.DB_Creds db = new MainModule.DB_Creds();
                Connection connection = db.ConnectToDB();
                Statement stmt;
                stmt = connection.createStatement();
                int f = stmt.executeUpdate("delete from hosp_spec where hosp_spec_id=" + hs_id);
                if (f > 0) {
                    JOptionPane.showMessageDialog(null, "Specialization details deleted.");
                    jTextField1.setText("");
                    jLabel1.setText("");
                } else {
                    jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminEditDelHospSpec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminEditDelHospSpec().setVisible(true);
            }
        });
    }

 ...
 * @author HP
 */
public class HRAddPost extends javax.swing.JFrame {

    /**
     * Creates new form HRAddPost
     */
    public HRAddPost() {
        initComponents();
    }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        String post_name=jTextField1.getText();
        if(post_name.equals("")){
            JOptionPane.showMessageDialog(null, "Enter Post");
            return;
        }
        try{
            ...
            int f=stmt.executeUpdate("insert into posts(post_id,post_name) values(NULL,'"+post_name+"')");
            if(f>0){
                JOptionPane.showMessageDialog(null,"Post details saved.");
                jTextField1.setText("");
            }
            else{
                jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HRAddPost.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

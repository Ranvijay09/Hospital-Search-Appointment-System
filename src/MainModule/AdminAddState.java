 ...
 * @author HP
 */
public class AdminAddState extends javax.swing.JFrame {

    /**
     * Creates new form AdminAddState
     */
    public class Item {
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        String state_name=jTextField1.getText();
        ...
        try{
            ...
            Statement stmt;
            stmt=connection.createStatement();
            int f=stmt.executeUpdate("insert into states(state_id,state_name,country_id) values(NULL,'"+state_name+"',"+c_id+")");
            if(f>0){
                JOptionPane.showMessageDialog(null,"State details saved.");
                jTextField1.setText("");
            }
            else{
                jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminAddState.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAddState().setVisible(true);
            }
        });
    }

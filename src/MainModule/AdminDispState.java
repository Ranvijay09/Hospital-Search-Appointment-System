 ...
 * @author HP
 */
public class AdminDispState extends javax.swing.JFrame {

    /**
     * Creates new form AdminDispState
     */
    public class Item {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Selected State");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminDispState.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminDispState().setVisible(true);
            }
        });
    }

 ...
 * @author HP
 */
public class AdminAddHRDet extends javax.swing.JFrame {

    /**
     * Creates new form AdminAddHRDet
     */
    public class Item {
    ...
    public void loadHospitals() {
        try {
            ...
            Statement stmt;
            stmt = connection.createStatement();
            ResultSet rs = stmt.executeQuery("select * from hosp_details");
            while (rs.next()) {
        ...
        if (dateValidation(hrdob) == true) {
            if (diffValidation(hrdob) == true) {
                ...
                try {
                    ...
                    Statement stmt;
                    stmt = connection.createStatement();
                    int f = stmt.executeUpdate("insert into hr_details(hr_id,hr_lname,hr_fname,hr_mname,hr_address,hr_gender,hr_dob,hr_contact,hr_email,hr_pwd,hr_country,hr_state,hr_dist,hr_tal,hr_speciality,hr_hosp) values(NULL,'" + hrlname + "','" + hrfname + "','" + hrmname + "','" + hraddr + "','" + hrgender + "'," +hrdob+ ",'" + hrcontact + "','" + hremail + "','" + hrpwd + "'," + cid + "," + sid + "," + did + "," + tid + "," + spid + "," + hid + ")");
                    if (f > 0) {
                        JOptionPane.showMessageDialog(null, "HR details added.");
                        jTextField3.setText("");
                        jTextField4.setText("");
                        jTextField5.setText("");
                        jTextField6.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminAddHRDet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAddHRDet().setVisible(true);
            }
        });
    }

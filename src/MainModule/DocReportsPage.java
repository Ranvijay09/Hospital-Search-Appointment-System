 ...
 * @author HP
 */
public class DocReportsPage extends javax.swing.JFrame {

    /**
     * Creates new form DocReportspage
     */
    ...
    public void loadTables() {
        ...
        if (choice.equals("Appointments")) {
            loadAppointments();
        }
    }

    public DocReportsPage() {
        initComponents();
        loadTables();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Doctor Reports");
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Appointments", "Patients" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DocReportsPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DocReportsPage().setVisible(true);
            }
        });
    }

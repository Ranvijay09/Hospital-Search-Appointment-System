 ...
 * @author HP
 */
public class AdminEditDelDist extends javax.swing.JFrame {

    /**
     * Creates new form AdminEditDelDist
     */
    public class Item {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modify/Delete District");
        ...
        jLabel4.setText("New District Name");
        ...
        jLabel7.setText("Selected District");
        ...
        jLabel8.setText("Select District");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null,"Please select district.");
            return;
        }
        int d_id=jComboBox3.getItemAt(this.jComboBox3.getSelectedIndex()).getID();
        String d_name=jTextField1.getText().toString();
        if(d_name.equals(""))
        {
            JOptionPane.showMessageDialog(null,"Please enter new district name.");
            return;
        }
        try{
            MainModule.DB_Creds db=new MainModule.DB_Creds();
            ...
            Statement stmt;
            stmt=connection.createStatement();
            int f=stmt.executeUpdate("update district set dist_name='"+d_name+"' where dist_id="+d_id);
            if(f>0){
                JOptionPane.showMessageDialog(null,"District details updated.");
                jTextField1.setText("");
                jLabel1.setText("");
            }
            else{
        ...
        dispose();
        MainModule.AdminEditDelDist aedc = new MainModule.AdminEditDelDist();
...
int confirm = JOptionPane.showConfirmDialog(null,
                "Do you want to delete district?", "Confirmation Message", JOptionPane.YES_NO_OPTION);
        if (confirm == 0) {
        try{
            MainModule.DB_Creds db=new MainModule.DB_Creds();
            Connection connection= db.ConnectToDB();
            Statement stmt;
            stmt=connection.createStatement();
            int f=stmt.executeUpdate("delete from district where dist_id="+d_id);
            if(f>0){
                JOptionPane.showMessageDialog(null,"District details deleted.");
                jTextField1.setText("");
                jLabel1.setText("");
            }
            else{
    ...
    private void jComboBox3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox3ActionPerformed
        ...
        if(jComboBox3.getItemCount() != 0){
            String dist = jComboBox3.getSelectedItem().toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminEditDelDist.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminEditDelDist().setVisible(true);
            }
        });
    }

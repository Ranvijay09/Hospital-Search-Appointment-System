 ...
 * @author HP
 */
public class AdminEditDelTal extends javax.swing.JFrame {

    /**
     * Creates new form AdminEditDelTal
     */
    public class Item {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modify/Delete Taluka");
        ...
        jLabel4.setText("New Taluka Name");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (jLabel1.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Please select taluka.");
            return;
        }
        int t_id = jComboBox4.getItemAt(this.jComboBox4.getSelectedIndex()).getID();
        String t_name = jTextField1.getText().toString();
        if (t_name.equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter new taluka name.");
            return;
        }
        try {
            MainModule.DB_Creds db = new MainModule.DB_Creds();
            ...
            Statement stmt;
            stmt = connection.createStatement();
            int f = stmt.executeUpdate("update taluka set tal_name='" + t_name + "' where tal_id=" + t_id);
            if (f > 0) {
                JOptionPane.showMessageDialog(null, "Taluka details updated.");
                jTextField1.setText("");
                jLabel1.setText("");
            } else {
                jTextField1.setText("");
        ...
        dispose();
        MainModule.AdminEditDelTal aedc = new MainModule.AdminEditDelTal();
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(null,
                "Do you want to delete speciality?", "Confirmation Message", JOptionPane.YES_NO_OPTION);
        if (confirm == 0) {
            try {
                MainModule.DB_Creds db = new MainModule.DB_Creds();
                Connection connection = db.ConnectToDB();
                Statement stmt;
                stmt = connection.createStatement();
                int f = stmt.executeUpdate("delete from taluka where tal_id=" + t_id);
                if (f > 0) {
                    JOptionPane.showMessageDialog(null, "Taluka details deleted.");
                    jTextField1.setText("");
                    jLabel1.setText("");
                } else {
                    jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminEditDelTal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminEditDelTal().setVisible(true);
            }
        });
    }

 ...
 * @author HP
 */
public class AdminAddCountry extends javax.swing.JFrame {

    /**
     * Creates new form AdminAddCountry
     */
    public AdminAddCountry() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Add New Country");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        String country_name=jTextField1.getText();
        ...
        try{
            ...
            int f=stmt.executeUpdate("insert into country(country_id,country_name) values(NULL,'"+country_name+"')");
            if(f>0){
                JOptionPane.showMessageDialog(null,"Country details saved.");
                jTextField1.setText("");
            }
            else{
                jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminAddCountry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAddCountry().setVisible(true);
            }
        });
    }

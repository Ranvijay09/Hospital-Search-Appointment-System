 ...
 * @author HP
 */
public class HRReportsPage extends javax.swing.JFrame {

    /**
     * Creates new form HRReportsPage
     */
     private TableRowSorter sorter;

    public void loadAppReqs() {
...
colModel.getColumn(2).setPreferredWidth(400);
    ...
    public void loadTables() {
        ...
        if (choice.equals("Appointment Requests")) {
            loadAppReqs();
        }
        if (choice.equals("Confirmed Appointments")) {
            loadConApps();
        }
        ...
        if (choice.equals("Payments")) {
            loadPayments();
        }
    }
    public HRReportsPage() {
        initComponents();
        loadTables();
    }
    ...
    private void initComponents() {
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Appointment Requests", "Confirmed Appointments", "Doctors", "Staff", "Patients", "Payments" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HRReportsPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HRReportsPage().setVisible(true);
            }
        });
    }

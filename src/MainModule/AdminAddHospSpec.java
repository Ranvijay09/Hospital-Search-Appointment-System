 ...
 * @author HP
 */
public class AdminAddHospSpec extends javax.swing.JFrame {

    /**
     * Creates new form AdminAddHospSpec
     */
    public AdminAddHospSpec() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Add New Specialization");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        // TODO add your handling code here:
        String hs_name=jTextField1.getText();
        if(hs_name.equals("")){
            JOptionPane.showMessageDialog(null, "Enter hospital speciality.");
            return;
        }
        try{
            ...
            int f=stmt.executeUpdate("insert into hosp_spec(hosp_spec_id,hosp_spec_name) values(NULL,'"+hs_name+"')");
            if(f>0){
                JOptionPane.showMessageDialog(null,"Hospital speciality saved.");
                jTextField1.setText("");
            }
            else{
                jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminAddHospSpec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAddHospSpec().setVisible(true);
            }
        });
    }

 ...
 * @author HP
 */
public class HRAddDocDet extends javax.swing.JFrame {

    /**
     * Creates new form HRAddDocDet
     */
                        ...
                        .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jComboBox7, javax.swing.GroupLayout.PREFERRED_SIZE, 480, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(kGradientPanel1Layout.createSequentialGroup()
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        dispose();
        MainModule.HRAddDocDet ahd = new MainModule.HRAddDocDet();
        ahd.setVisible(true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        int hid = log_hosp_id;
        if (drlname.equals("") || dr_join_date.equals("") || drfname.equals("") || drmname.equals("") || draddr.equals("") || drgender.equals("") || drdob.equals("") || drcontact.equals("") || dremail.equals("") || drpwd.equals("") || cid <= 0 || sid <= 0 || did <= 0 || tid <= 0 || spid <= 0 || hid <= 0) {
        ...
        if (dateValidation(drdob) == true && dateValidation(dr_join_date) == true) {
            if (diffValidation(drdob) == true && diffValidation(dr_join_date) == true) {
                ...
                try {
                    ...
                    Statement stmt;
                    stmt = connection.createStatement();
                    int f = stmt.executeUpdate("insert into dr_details(dr_id,dr_lname,dr_fname,dr_mname,dr_address,dr_gender,dr_dob,dr_contact,dr_email,dr_pwd,dr_country,dr_state,dr_dist,dr_tal,dr_spec,dr_hosp,dr_join_date ) values(NULL,'" + drlname + "','" + drfname + "','" + drmname + "','" + draddr + "','" + drgender + "','" + drdob + "','" + drcontact + "','" + dremail + "','" + drpwd + "'," + cid + "," + sid + "," + did + "," + tid + "," + spid + "," + hid + "," + dr_join_date + ")");
                    if (f > 0) {
                        JOptionPane.showMessageDialog(null, "Doctor details added.");
                        jTextField3.setText("");
                        jTextField4.setText("");
                        jTextField5.setText("");
                        jTextField6.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HRAddDocDet.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HRAddDocDet().setVisible(true);
            }
        });
    }

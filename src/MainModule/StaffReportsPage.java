 ...
 * @author HP
 */
public class StaffReportsPage extends javax.swing.JFrame {

    /**
     * Creates new form StaffReportsPage
     */
    ...
    private void initComponents() {
        ...
        jComboBox7.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Patients", "Payments" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StaffReportsPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StaffReportsPage().setVisible(true);
            }
        });
    }

 ...
 * @author HP
 */
public class HREditDelDept extends javax.swing.JFrame {

    /**
     * Creates new form HREditDelDept
     */
    public class Item {
    ...
    public void loadDepts() {
        try {
            ...
            while (rs.next()) {
                ...
                String cname = rs.getString("dept_name");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modify/Delete Department");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        dispose();
        MainModule.HRAddDept aac=new  MainModule.HRAddDept();
        aac.setVisible(true);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        dispose();
        MainModule.HRDispDept adc=new  MainModule.HRDispDept();
        adc.setVisible(true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if (c_name.equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter new department name.");
            return;
        }
        try {
            MainModule.DB_Creds db = new MainModule.DB_Creds();
            ...
            Statement stmt;
            stmt = connection.createStatement();
            int f = stmt.executeUpdate("update depts set dept_name='" + c_name + "' where dept_id=" + c_id);
            if (f > 0) {
                JOptionPane.showMessageDialog(null, "Department details updated.");
                jTextField3.setText("");
                jLabel1.setText("");
            } else {
                jTextField3.setText("");
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(null,
            "Do you want to delete department?", "Confirmation Message", JOptionPane.YES_NO_OPTION);
        if (confirm == 0) {
            try {
                MainModule.DB_Creds db = new MainModule.DB_Creds();
                Connection connection = db.ConnectToDB();
                Statement stmt;
                stmt = connection.createStatement();
                int f = stmt.executeUpdate("delete from depts where dept_id=" + c_id);
                if (f > 0) {
                    JOptionPane.showMessageDialog(null, "Department details deleted.");
                    jTextField3.setText("");
                    jLabel1.setText("");
                } else {
                    jTextField3.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HREditDelDept.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HREditDelDept().setVisible(true);
            }
        });
    }

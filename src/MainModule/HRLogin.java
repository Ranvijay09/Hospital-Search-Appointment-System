...
public class HRLogin extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            int f = 0;
            while (rs.next()) {
                String usr = rs.getString("hr_email");
                String pwd = rs.getString("hr_pwd");
            ...
            if (f == 1) {
                ...
                String hrname = rs.getString("hr_lname")+rs.getString("hr_fname")+rs.getString("hr_mname");
                String hremail = rs.getString("hr_email");
                int hrhospid = rs.getInt("hr_hosp");
                try {
                    int status = stmt.executeUpdate("insert into hr_log_data(hr_id,hr_name,hr_email,hr_hosp_id) values(" + hrid + ",'" + hrname + "','" + hremail + "'," + hrhospid + ")");
                } catch (HeadlessException | NumberFormatException | SQLException e) {
                    System.out.println("Exception: " + e);
                }
                dispose();
                MainModule.HRMainPage hm = new MainModule.HRMainPage();
                hm.setVisible(true);
            } else {

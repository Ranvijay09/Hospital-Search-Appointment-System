 ...
 * @author HP
 */
public class AdminEditDelState extends javax.swing.JFrame {

    /**
     * Creates new form AdminEditDelState
     */
    public class Item {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Modify/Delete State");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
        dispose();
        MainModule.AdminEditDelState aeds = new MainModule.AdminEditDelState();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        // TODO add your handling code here:
        dispose();
        MainModule.AdminDispState ads = new MainModule.AdminDispState();
        ads.setVisible(true);
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        String s_name = jTextField3.getText().toString();
        if (s_name.equals("")) {
            JOptionPane.showMessageDialog(null, "Please enter new state name.");
            return;
        }
        try {
            MainModule.DB_Creds db = new MainModule.DB_Creds();
            ...
            Statement stmt;
            stmt = connection.createStatement();
            int f = stmt.executeUpdate("update states set state_name='" + s_name + "' where state_id=" + s_id);
            if (f > 0) {
                JOptionPane.showMessageDialog(null, "State details updated.");
                jTextField3.setText("");
                jLabel1.setText("");
            } else {
                jTextField3.setText("");
        ...
        dispose();
        MainModule.AdminEditDelState aedc = new MainModule.AdminEditDelState();
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        int confirm = JOptionPane.showConfirmDialog(null,
                "Do you want to delete state?", "Confirmation Message", JOptionPane.YES_NO_OPTION);
        if (confirm == 0) {
            try {
                MainModule.DB_Creds db = new MainModule.DB_Creds();
                Connection connection = db.ConnectToDB();
                Statement stmt;
                stmt = connection.createStatement();
                int f = stmt.executeUpdate("delete from states where state_id=" + s_id);
                if (f > 0) {
                    JOptionPane.showMessageDialog(null, "State details deleted.");
                    jTextField3.setText("");
                    jLabel1.setText("");
                } else {
                    jTextField3.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminEditDelState.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminEditDelState().setVisible(true);
            }
        });
    }

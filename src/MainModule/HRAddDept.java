 ...
 * @author HP
 */
public class HRAddDept extends javax.swing.JFrame {

    /**
     * Creates new form HRAddDept
     */
    private int log_hr_id;
    private int log_hosp_id;
    private void HRLogData()
    {
        try {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Add New Department");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try{
            ...
            Statement stmt;
            stmt=connection.createStatement();
            int f=stmt.executeUpdate("insert into depts(dept_id,dept_name) values(NULL,'"+dept_name+"')");
            if(f>0){
                JOptionPane.showMessageDialog(null,"Department details saved.");
                jTextField1.setText("");
            }
            else{
                jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HRAddDept.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

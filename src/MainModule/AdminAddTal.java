 ...
 * @author HP
 */
public class AdminAddTal extends javax.swing.JFrame {

    /**
     * Creates new form AdminAddTal
     */
    public class Item {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Add New Taluka");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        try{
            ...
            Statement stmt;
            stmt=connection.createStatement();
            int f=stmt.executeUpdate("insert into taluka(tal_id,tal_name,dist_id,state_id,country_id) values(NULL,'"+t_name+"',"+d_id+","+s_id+","+c_id+")");
            if(f>0){
                JOptionPane.showMessageDialog(null,"Taluka details saved.");
                jTextField1.setText("");
            }
            else{
                jTextField1.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminAddTal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminAddTal().setVisible(true);
            }
        });
    }
